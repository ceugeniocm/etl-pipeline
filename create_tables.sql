CREATE TABLE tb_agendamentos (
    ...
    ag_dthoraatendimento DATETIME NULL,
    ag_dthoracancel DATETIME NULL,
    ag_dthoratransf DATETIME NULL,
    ...
    ag_dthoraliberacao DATETIME NULL,
    ag_datahoraconfirmacao DATETIME NULL,
    ag_dthagendamento DATETIME NULL,
    ...
    benef_cpf BIGINT NULL,
    benef_rn INT NULL,
    benef_sexo VARCHAR(50) NULL,
    benef_temporario INT NULL,
    benef_bairro VARCHAR(255) NULL,
    benef_dddresid INT NULL,
    benef_resid INT NULL,
    benef_dddcelular INT NULL,
    benef_celular INT NULL,
    benef_dddcomercial VARCHAR(10) NULL,
    benef_comercial VARCHAR(50) NULL,
    reg_descricao VARCHAR(255) NULL,
    benef_numcarteira DOUBLE PRECISION NULL,
...
CREATE TABLE tb_beneficiarios (
    ...
    numcarteira DOUBLE PRECISION NULL
);
